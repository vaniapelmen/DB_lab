...
class Controller:
    ...
    def add_customer(self):
        try:
            ...
            self.model.insert_customer(name, phone, email, travel_id, comp_id, place_id)
    ...
    def add_trcomp(self):
        try:
            ...
            self.model.insert_trcomp(comp_name, comp_address, comp_phone)
    ...
    def add_travel(self):
        try:
            ...
            self.model.insert_travel(time, form, pay)
    ...
    def add_place(self):
        try:
            ...
            self.model.insert_place(country, city)
    ...
    def show_customers(self):
        try:
            customers = self.model.show_customers()
            self.view.show_customers(customers)
        except Exception as e:
            self.view.show_message(f"Something went wrong: {e}")

    def show_trcomps(self):
        try:
            trcomps = self.model.show_trcomps()
    ...
    def show_travels(self):
        try:
            travels = self.model.show_travels()
